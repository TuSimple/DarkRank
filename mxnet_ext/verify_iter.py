...
class VerifyIter(mx.io.DataIter):
    '''
    Data iterator
    Combine two iterators (one totally shuffles, one contains pairs)
    '''
    def __init__(self, data_iter1, data_iter2,
                 use_verifi=False, use_center=False, use_lsoftmax=False, use_softmax=True, gpus=1):
        super(VerifyIter, self).__init__()
    ...
    def provide_label(self):
        ...
        labels = []
        if self.use_softmax:
            labels.append(('softmax_label', (self.batch_size,)))
